...
if __name__ == "__main__":
    ...
    dim = args.mimc_dim
    if dim == 1:
        base = "mimc_run.py -mimc_TOL {TOL} -mimc_max_TOL 0.5  -mimc_min_dim 1 -qoi_seed {seed} \
    ...
    -mimc_bayesian {bayesian} ".format(bayesian="{bayesian}", TOL="{TOL}",
        ...
        base = "mimc_run.py -mimc_TOL {TOL} -mimc_max_TOL 0.5  -mimc_min_dim 2 -qoi_seed {seed} \
